	...
	if (imageList.getImages() != null)
	{
		if (imageList.getImages().getImageRef().size() > 0)
		{
			...
			for (Iterator<ImageList.Images.ImageRef> imageIterater = imageList.getImages().getImageRef().iterator(); imageIterater.hasNext();)
			{
				...
				if (isPreview)
				{
					imageMainPath = "../../../ws/" + (String)request.getAttribute("profileName") + "/imagepreview/" + current.getId() + "/" + mainImageWidth + "/" + mainImageHeight + "/";
					imageThumbPath = "../../../ws/" + (String)request.getAttribute("profileName") + "/imagepreview/" + current.getId() + "/" + imageSize + "/" + imageSize + "/";
				}
				else
				{
					imageMainPath = "../../../ws/" + (String)request.getAttribute("profileName") + "/image/" + current.getId() + "/" + mainImageWidth + "/" + mainImageHeight + "/";
					imageThumbPath = "../../../ws/" + (String)request.getAttribute("profileName") + "/image/" + current.getId() + "/" + imageSize + "/" + imageSize + "/";
				}
